...
\begin{tabularx}{\textwidth}{|l|X|X|X|X|}
 ...
 \hline Trigger & 
 \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{L'amministratore preme il pulsante "Login" nella schermata Login visibile all'avvio del software.} \\
\hline
%Main Scenario%
...
\renewcommand{\arraystretch}{1.5}
    \begin{tabularx}{\textwidth}{|c|X|X|}
        ...
        \hline
         ...
         \hline
         2 &Preme il pulsante "Login" dalla schermata Login  & \\
         \hline
