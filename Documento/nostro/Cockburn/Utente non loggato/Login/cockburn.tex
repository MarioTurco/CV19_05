...
\begin{table}[H]
\caption{L'utente effettua il Login - Main Scenario}
  ...
  \begin{table}[h!]
    \caption{Effettua Login - Estensione 1}
        \begin{tabularx}{\textwidth}{|c|X|X|}
            ...
            \hline
             ...
             \hline
             3 a & & Mostra schermata Dati errati Dialog e termina caso d'uso \\
             \hline        
        \end{tabularx}
      \end{table}
      %Extension 2%
    ...
    \begin{tabularx}{\textwidth}{|c|X|X|}
      ...
      \hline
       ...
       \hline
       3 b & & Mostra schermata 'Campi vuoti Dialog' e termina caso d'uso\\
       \hline        
  \end{tabularx}
\end{table}
\pagebreak
...
\begin{table}[h!]
  ...
  \hline
   3 c & & Mostra schermata "server irraggiungibile dialog" e termina caso d'uso\\
   \hline
\end{tabularx} 
\end{table}
