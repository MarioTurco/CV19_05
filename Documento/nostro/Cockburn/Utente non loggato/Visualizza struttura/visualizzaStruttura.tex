...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|X|X|X|}
     \rowcolor{Gray}
      \hline Use Case \#3 & \multicolumn{4} {l|}{L'utente  visulizza una struttura} \\ \hline Goal in
      Context & \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{%
        L'utente  vuole visualizzare i dettagli  di  una struttura} \\
     \hline Preconditions & \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{%
    - } \\
     \hline Success End Conditions &
     \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{ L'utente visualizza con successo i dettagli di una struttura} \\
     ...
     \hline Trigger & 
     \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{L'utente clicca sulla card di una struttura dalla schermata "Lista Strutture"} \\
    \hline
    %Main Scenario%
