...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|X|X|X|}
        \rowcolor{Gray}
      \hline Use Case \#3 & \multicolumn{4} {l|}{L'utente aggiunge una recensione} \\ \hline Goal in
     ...
     \hline Trigger & 
     \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{L'utente clicca sul Floating Action Button e preme su "Aggiungi recensione" dalla schermata "Pagina Struttura"} \\
    \hline
    %Main Scenario%
