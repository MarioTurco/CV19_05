...
public class FiltriUnitTest {
    ...
    public void getFiltriNonVuoti_BranchCoverage_2_a_15_18_19_21(){
        ...
        String returnString = "&nome=%25a%25&citta=%25a%25&categoria=a&fascia_di_prezzo=a&valutazione_media=1&radius=1&x=0.0&y=0.0";
    ...
    public void getFiltriNonVuoti_BranchCoverage_2_a_14_17_18_19_21(){
        ...
        String returnString = "&nome=%25a%25&citta=%25a%25&categoria=a&fascia_di_prezzo=a&valutazione_media=1&radius=0&x=0.0&y=0.0";
        assertEquals(returnString, filtri.getFiltriNonVuoti(0.0,0.0));
    }
}
