...
\begin{tabularx}{\textwidth}{|l|X|X|X|X|}
  \hline Use Case \#3 & \multicolumn{4} {l|}{Utente effettua Login} \\ \hline Goal in
...
\renewcommand{\arraystretch}{1.5}
    ...
    \begin{tabularx}{\textwidth}{|c|X|X|}
      ...
      Step\# & Utente & Sistema \\
      \hline
       1 a &  Non compila o compila solo un tra i textField Username e Password& \\
       \hline
       2 a & Preme il pulsante Login & \\
       \hline
       3 a & & Mostra schermata Login campi vuoti Dialog \\
       \hline
       4 a & Preme il tasto 'Riprova'&  \\
       \hline
       5 a & & Mostra Login e termina caso d'uso\\
...
\begin{tabularx}{\textwidth}{|c|X|X|}
  \hline
  \multicolumn{3}{|>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}c|}{Extension 1: il server risulta non raggiungibile}\\\hline
  Step\# & Utente & Sistema \\
  \hline
   1 a &  Non compila o compila solo un tra i textField Username e Password& \\
   \hline
   2 a & Preme il pulsante Login & \\
   \hline
   3 a & & Mostra schermata Login server irraggiungibile \\
   \hline
   4 a & Preme il tasto 'Riprova'&  \\
   \hline
   5 a & & Mostra Login e termina caso d'uso\\
