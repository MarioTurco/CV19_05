...
\begin{tabularx}{\textwidth}{|l|X|X|X|X|}
  \hline Use Case \#2 & \multicolumn{4} {l|}{Accetta Recensione} \\ \hline Goal in
  Context & \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{%
    L'amministratore accetta una recensione.} \\
 ...
 \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{ L'amministratore accetta una recensione. Il sistema tiene traccia di tale operazione.} \\
 \hline Failed End Conditions &
 \multicolumn{4}{>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}X|}{L'amministatore preme annulla. Non ci sono recensioni da valutare. L'amministrazione valuta una recensione che è già stata valutata.} \\
 \hline Primary Actor &
...
\renewcommand{\arraystretch}{1.5}
    \begin{tabularx}{\textwidth}{|c|X|X|}
        ...
        Step\# & Amministratore & Sistema \\
        \hline
         3/5 a &Preme il pulsante "Annulla". & \\
         \hline
 ...
 \renewcommand{\arraystretch}{1.5}
     \begin{tabularx}{\textwidth}{|c|X|X|}
        ...
        \multicolumn{3}{|>{\hsize=\dimexpr 4\hsize+4\tabcolsep+2\arrayrulewidth\relax}c|}{Extension 2: la recensione è già stata valutata }\\\hline
         Step\# & Amministratore & Sistema \\
         \hline
          6 b  & & Mostra Fallimento Dialog \\
          \hline
          7 b & Preme Ok & \\
          \hline
          8 b &  & Ritorna alla schermata principale e termina il caso d'uso.\\
         \hline
     \end{tabularx}
\end{table}
